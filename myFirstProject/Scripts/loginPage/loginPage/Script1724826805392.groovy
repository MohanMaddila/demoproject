...
WebUI.verifyElementPresent(findTestObject('Object Repository/loginPage/companyBrandingLogo'), 5)

WebUI.verifyElementPresent(findTestObject('Object Repository/loginPage/orangeHrmLogo'), 5)
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/loginPage/loginButton'), 5)
